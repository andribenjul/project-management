...
<html lang="en">
    <head>
        ...
        <title>CV Garoeda - Task Management</title>
        ...
        <nav id="myNavbar" class="navbar navbar-default" role="navigation">
            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="">CV Garoeda</a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li>
                            <a href="{{ route('project.show') }}"><span class="glyphicon glyphicon-list" aria-hidden="true"></span> Orders</a>
                        </li>
        ...
        <div class="footer-bottom">
            ...
            <div class="container">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 text-right">
                    ...
                    <div class="design">
                        <a target="_blank" href="">CV Garoeda</a>
                    </div>
